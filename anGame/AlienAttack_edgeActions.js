...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         sym.getSymbolElement().fadeIn('slow');
   ...
   (function(symbolName) {   
      ...
      Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function(sym, e) {
         ...
         function init(){
         	sym.$('TAP').bind('click touchstart',function(){
      ...
      Symbol.bindElementAction(compId, symbolName, "${RPG}", "click", function(sym, e) {
         // insert code for mouse click here
         window.open("anGameInstruction/AlienAttack.html", "_self");
      ...
      Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function(sym, e) {
         ...
         function initAliens(){
         	...
         	$.each(aliens, function( count, a ){
         		a.getVariable('init')(Math.floor(Math.random() * 3) * 1 + 1);
